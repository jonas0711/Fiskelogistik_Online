...
export default function UserList() {
  console.log(`${LOG_PREFIXES.users} Renderer UserList komponent...`);
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      console.log(`${LOG_PREFIXES.users} Henter brugerliste...`);
      ...
      try {
        ...
        console.log(`${LOG_PREFIXES.users} API response status:`, response.status);
        
        const result = await response.json();
        console.log(`${LOG_PREFIXES.users} API response data:`, result);
        
        if (result.success && result.data) {
          console.log(`${LOG_PREFIXES.success} Brugerliste hentet:`, result.data.length, 'brugere');
          setUsers(result.data);
        } else {
          console.error(`${LOG_PREFIXES.error} Fejl ved hentning af brugere:`, result.error);
          setError(result.error || result.message);
        }
        
      } catch (error) {
        console.error(`${LOG_PREFIXES.error} Uventet fejl ved hentning af brugere:`, error);
  ...
  const handleDeleteUser = async (email: string) => {
    console.log(`${LOG_PREFIXES.delete} Sletter bruger:`, email);
    ...
    try {
      ...
      console.log(`${LOG_PREFIXES.delete} API response status:`, response.status);
      
      const result = await response.json();
      console.log(`${LOG_PREFIXES.delete} API response data:`, result);
      ...
      if (result.success) {
        ...
        console.error(`${LOG_PREFIXES.error} Fejl ved sletning af bruger:`, result.error);
        alert(result.error || result.message);
      }
      
    } catch (error) {
      console.error(`${LOG_PREFIXES.error} Uventet fejl ved sletning af bruger:`, error);
